function [gameOver, enemyClear] = battle(playerHp, playerDmg, mapSize, enemyClear, coins, name)
    playerHpOg = playerHp;
    enemyHpTable = [2 4 5 6];
    enemyHp = enemyHpTable(randi([1,4]))+coins; %more health with more coins
    enemyHpOg = enemyHp;
    gameOver = false;
    introTrigger = true;
    ...
    battleRefresh(mapSize, introTrigger, playerHp, enemyHp, enemyHpOg, playerHpOg, name)
    introTrigger = false;
